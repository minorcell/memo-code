...
description: 'Session file layout, resume behavior, and local history management.'
order: 8
category: 'Operations'
---
...
- Context window follows model profile config (`context_window`) and is re-applied on `/models` switch.
