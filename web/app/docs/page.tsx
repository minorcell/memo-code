...
import { ArrowRight, BookOpen, Zap, Sparkles, Terminal, ExternalLink, Puzzle, Settings } from 'lucide-react'
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-[var(--text-secondary)]">
                  Can&apos;t find what you&apos;re looking for? Check our troubleshooting guide or
